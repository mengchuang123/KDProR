...
def main():
    ...
    try:
        shutil.copy("scripts/r4r_msrvtt.sh", args.output_dir)
        shutil.copy("tvr/models/modeling.py", args.output_dir)
        shutil.copy("tvr/models/knowledge_store.py", args.output_dir)   
        shutil.copy("tvr/models/knowledge_searcher.py", args.output_dir)   
        shutil.copy("tvr/models/utils_function/sinkhorn_knopp.py", args.output_dir)  
        shutil.copy("main.py", args.output_dir)  
    except:
        print("copy error")
